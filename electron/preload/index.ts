...
const api: SkillManagerApi = {
  ...
  previewLocalFolderImport: (folderPath) => ipcRenderer.invoke("skill-manager:preview-local-folder-import", folderPath),
  commitFolderImport: (input) => ipcRenderer.invoke("skill-manager:commit-folder-import", input),
  addRemoteSource: (url) => ipcRenderer.invoke("skill-manager:add-remote-source", url),
  previewTrustedRemoteInstall: (stagedSourceId) => ipcRenderer.invoke("skill-manager:preview-trusted-remote-install", stagedSourceId),
  executeTrustedRemoteInstall: (input) => ipcRenderer.invoke("skill-manager:execute-trusted-remote-install", input),
  ...
  addSyncTarget: (input) => ipcRenderer.invoke("skill-manager:add-sync-target", input),
  ...
  previewSync: (input) => ipcRenderer.invoke("skill-manager:preview-sync", input),
  executeSyncDecision: (input) => ipcRenderer.invoke("skill-manager:execute-sync-decision", input),
  listSkillSnapshots: (skillId) => ipcRenderer.invoke("skill-manager:list-skill-snapshots", skillId),
  saveSkillMarkdown: (input) => ipcRenderer.invoke("skill-manager:save-skill-markdown", input),
  restoreSkillSnapshot: (input) => ipcRenderer.invoke("skill-manager:restore-skill-snapshot", input),
